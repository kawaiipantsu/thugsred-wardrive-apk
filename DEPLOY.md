...
Per-OS, step-by-step guides moved to [`docs/`](docs/):

- [Deploy on macOS](docs/Deploy-macOS.md)
- [Deploy on Linux](docs/Deploy-Linux.md)
- [Deploy on Windows](docs/Deploy-Windows.md)
...
> approval). Scanning, the map and local CSV export work without one.
